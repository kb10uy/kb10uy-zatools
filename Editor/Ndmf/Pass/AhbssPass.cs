...
namespace KusakaFactory.Zatools.Ndmf.Pass
{
    ...
    {
        protected override string ZatoolsPassName => nameof(AhbssGenerating);
        protected override string ZatoolsPassDescription => "Split BlendShapes";
        ...
        private void ProcessFor(AhbssComponent component, SkinnedMeshRenderer skinnedMeshRenderer, Transform avatarRoot)
        {
            ...
            {
                ErrorReport.ReportError(new ZatoolsNdmfError(component.gameObject, ErrorSeverity.NonFatal, "ahbss.report.missing-mesh"));
