...
namespace KusakaFactory.Zatools.Ndmf.Pass
{
    internal sealed class EdwGenerating : ZatoolsPass<EdwGenerating>
    {
        ...
        protected override string ZatoolsPassName => nameof(EdwGenerating);
        protected override string ZatoolsPassDescription => "Generate overlapping mesh for depth override";
